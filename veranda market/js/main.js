/* ===================================
   VERANDA MARKET - MAIN JAVASCRIPT (UPDATED)
   Now with Product Detail Page Integration
   =================================== */
  ...
  document.addEventListener('keydown', (e) => {
    ...
    if ((e.ctrlKey || e.metaKey) && e.key === 'k') {
      ...
      if (searchInput) {
        ...
        // Add a glow effect when focused via keyboard
        if (searchWrapper) {
...
function initFeaturedCategoriesCarousel() {
  ...
  function updateCarousel(index) {
    ...
    // Add active state to middle visible card
    cards.forEach((card, i) => {
