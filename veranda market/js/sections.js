/* ===================================
   SHOP BY CATALOGUE - V2 JAVASCRIPT (UPDATED)
   Fixed Load More Functionality + Product Detail Integration
   =================================== */
...
const CatalogueV2 = (function() {
  ...
  const mockData = {
    ...
    // Extended product list for pagination - NOW WITH IDs
    moreProducts: [
      {
        id: 'prod-s001',
  ...
  function loadMoreProducts(initial = false) {
    ...
    setTimeout(() => {
      ...
      // Add click handlers to new products
...
/* ===================================
   ...
   Interactive functionality for elegant footer
   =================================== */
...
const ModernFooter = (function() {
  ...
  function animateFooterElements() {
    // Already handled by CSS animations, but we can add JS enhancements here
